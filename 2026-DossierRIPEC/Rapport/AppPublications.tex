...
%---------------------------------------------------------------------
\paragraph{Brevets, licences, logiciels.} \todo{}
J'ai été associé au développement de différents packages développé en langage R. Je me restreint ici à ceux qui sont à ce jour disponibles sur le site officiel du CRAN ({\sl The Comprehensive R Archive Network} : \url{cran.r-project.org/}) :
\begin{itemize}
